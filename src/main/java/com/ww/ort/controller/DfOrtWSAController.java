 ...
 */
@Controller
@RequestMapping("/dfOrtWSA")
@Api(tags = "ORT滑动水滴角")
@ResponseBody
@CrossOrigin
public class DfOrtWSAController {
    ...
    public Result getBoxplot(
        ...
        return new Result(200,"获取箱线图数据成功",result);
    }
    ...
    public Result resultStatistics(
        ...
        result.add(allData);
        return new Result(200, "获取结果汇总数据成功", result);
    }
    ...
    public Result dayOrNightOkRate(
        ...
        return new Result(200, "获取班次良率数据成功", result);
    }
